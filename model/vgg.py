...
class B2_VGG(nn.Module):
    ...
    def __init__(self):
        ...
        pre_train = torch.load('CPD.pth', map_location=torch.device('cpu'))
    ...
    def _initialize_weights(self, pre_train):
        ...
        self.conv4_1.conv4_1_1.weight.data.copy_(pre_train[list(keys)[14]])
        self.conv4_1.conv4_2_1.weight.data.copy_(pre_train[list(keys)[16]])
        self.conv4_1.conv4_3_1.weight.data.copy_(pre_train[list(keys)[18]])
        self.conv5_1.conv5_1_1.weight.data.copy_(pre_train[list(keys)[20]])
        self.conv5_1.conv5_2_1.weight.data.copy_(pre_train[list(keys)[22]])
        self.conv5_1.conv5_3_1.weight.data.copy_(pre_train[list(keys)[24]])
        self.conv4_2.conv4_1_2.weight.data.copy_(pre_train[list(keys)[14]])
        self.conv4_2.conv4_2_2.weight.data.copy_(pre_train[list(keys)[16]])
        self.conv4_2.conv4_3_2.weight.data.copy_(pre_train[list(keys)[18]])
        self.conv5_2.conv5_1_2.weight.data.copy_(pre_train[list(keys)[20]])
        self.conv5_2.conv5_2_2.weight.data.copy_(pre_train[list(keys)[22]])
        self.conv5_2.conv5_3_2.weight.data.copy_(pre_train[list(keys)[24]])
        ...
        self.conv4_1.conv4_1_1.bias.data.copy_(pre_train[list(keys)[15]])
        self.conv4_1.conv4_2_1.bias.data.copy_(pre_train[list(keys)[17]])
        self.conv4_1.conv4_3_1.bias.data.copy_(pre_train[list(keys)[19]])
        self.conv5_1.conv5_1_1.bias.data.copy_(pre_train[list(keys)[21]])
        self.conv5_1.conv5_2_1.bias.data.copy_(pre_train[list(keys)[23]])
        self.conv5_1.conv5_3_1.bias.data.copy_(pre_train[list(keys)[25]])
        self.conv4_2.conv4_1_2.bias.data.copy_(pre_train[list(keys)[15]])
        self.conv4_2.conv4_2_2.bias.data.copy_(pre_train[list(keys)[17]])
        self.conv4_2.conv4_3_2.bias.data.copy_(pre_train[list(keys)[19]])
        self.conv5_2.conv5_1_2.bias.data.copy_(pre_train[list(keys)[21]])
        self.conv5_2.conv5_2_2.bias.data.copy_(pre_train[list(keys)[23]])
        self.conv5_2.conv5_3_2.bias.data.copy_(pre_train[list(keys)[25]])
