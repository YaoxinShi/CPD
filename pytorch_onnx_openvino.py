...
if use_sample_model:
    ...
    torch_model = model
    torch_model.load_state_dict(torch.load("CPD.pth", map_location=torch.device('cpu')))
    #torch_model.load_state_dict(torch.load('CPD-R.pth', map_location=torch.device('cpu')))
